...
**Backend:** Node.js • Express.js • Django • Flask • JWT • WebSocket  
**Databases/DevOps:** PostgreSQL • MySQL • MongoDB • Docker • CI/CD • Git  
**AI/ML:** TensorFlow • PyTorch • Scikit-learn • Transformers • Selenium • BeautifulSoup
